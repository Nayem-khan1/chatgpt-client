...
import "./App.css";
import "./normal.css";
import icon from "./chatgpt-icon.svg";
  ...
  return (
    <div className="App">
      <aside className="side-menu">
        <div onClick={clearChat} className="side-menu-btn">
          <span>+</span>New Chat
        </div>
        ...
        <div onClick={clearChat} className="side-menu-btn">
          Clear All<span className="clear"> X </span>
        </div>
      </aside>
        ...
        <div className="chat-input-holder">
          <form onSubmit={handleSubmit}>
            <input
              ...
              name=""
              placeholder="Hello, This Is Artificial Intelligence. How Can I Help You? "
            />
          </form>
        </div>
      </section>
